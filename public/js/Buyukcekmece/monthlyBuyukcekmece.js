...
function MonthlyBuyukcekmece() {
    $.post('../data/Buyukcekmece/getBuyukcekmeceMonthly.php', function (data) {
        ...
        $("#ay").html(`Büyükçekmece İçin ${datum[datum.length-1].getDate()}-${datum[datum.length-1].getMonth()+1}-${datum[datum.length-1].getFullYear()} ve  
        ...
        const graphTarget = $("#aylikbcekmece");

        let selectedVal = "";
        let selected = $("#radioDiv input[type='radio'][name='bcekmecegraphaylik']:checked");
