...
function DailyBuyukcekmece() {
    $.post('../data/Buyukcekmece/getBuyukcekmeceDaily.php', function (data) {
        ...
        $("#gun").html(`Büyükçekmece İçin ${datum[0].getDate()}-${datum[0].getMonth()+1}-${datum[0].getFullYear()} Tarihi Verileri`);
        ...
        const graphTarget = $("#gunlukbcekmece");

        let selectedVal = "";
        let selected = $("#radioDiv input[type='radio'][name='bcekmecegraphgunluk']:checked");
