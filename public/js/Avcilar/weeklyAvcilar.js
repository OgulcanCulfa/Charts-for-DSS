...
function WeeklyAvcilar() {
    $.post('../data/Avcilar/getAvcilarWeekly.php', function (data) {
        ...
        const graphTarget = $("#haftalikavcilar");

        let selectedVal = "";
        let selected = $("#radioDiv input[type='radio'][name='avcilargraphhaftalik']:checked");
