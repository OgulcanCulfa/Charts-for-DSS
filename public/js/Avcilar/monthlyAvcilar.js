...
function MonthlyAvcilar() {
    $.post('../data/Avcilar/getAvcilarMonthly.php', function (data) {
        ...
        const graphTarget = $("#aylikavcilar");

        let selectedVal = "";
        let selected = $("#radioDiv input[type='radio'][name='avcilargraphaylik']:checked");
