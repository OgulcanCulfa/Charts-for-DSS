...
function MonthlyBeylikduzu() {
    $.post('../data/Beylikduzu/getBeylikduzuMonthly.php', function (data) {
        ...
        const graphTarget = $("#aylikbduzu");

        let selectedVal = "";
        let selected = $("#radioDiv input[type='radio'][name='bduzugraphaylik']:checked");
